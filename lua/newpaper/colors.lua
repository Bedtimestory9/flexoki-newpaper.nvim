...
function M.setup(config)
    ...
    if config.style == "light" then
        newpaper = {
            black = "#100F0F", -- color00
            maroon = "#AF3029", -- color01
            darkgreen = "#66800B", -- color02
            darkorange = "#BC5215", -- color03
            navy = "#205EA6", -- color04
            purple = "#87285E", -- color05
            teal = "#1C6C66", -- color06
            darkgrey = "#403E3C", -- color08
            red = "#D14D41", -- color09
            green = "#768D21", -- color10
            orange = "#DA702C", -- color11
            lightblue = "#3171B2", -- color12
            lightmagenta = "#B74583", -- color13
            blue = "#2F968D", -- color14
            white = "#FFFCF0",
